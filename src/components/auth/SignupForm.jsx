  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-blue-700 mb-2">Join Breezy Bliss!</h2>
        <p className="text-blue-600">Create your account and start shopping</p>
      </div>
          ...
          <label className="flex items-start space-x-3">
            <div className="relative">
              ...
              <div className={`w-5 h-5 border-2 rounded flex items-center justify-center transition-all ${
                ...
                {agreedToTerms && <Check className="w-3 h-3 text-blue-700" />}
              </div>
            </div>
            <span className="text-sm text-blue-600 leading-5">
              I agree to the{' '}
              <button type="button" className="font-medium text-blue-700 hover:text-blue-800 underline">
                Terms of Service
              </button>{' '}
              and{' '}
              <button type="button" className="font-medium text-blue-700 hover:text-blue-800 underline">
