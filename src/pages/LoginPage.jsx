  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 to-amber-50 p-4">
      ...
      <div className="flex p-4">
        <div className="bg-gradient-to-br from-[#FEF3C7] to-yellow-100 rounded-3xl shadow-2xl w-full transform transition-all duration-300 scale-100">
          {/* Header */}
            ...
            <div className="w-full max-w-md mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-blue-600">
                  Sign in to your Breezy Bliss account
                </p>
              </div>
